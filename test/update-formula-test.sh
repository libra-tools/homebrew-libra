...
grep -Fq 'https://github.com/libra-tools/libra/releases/download/v0.17.1446/libra-darwin-arm64' "$formula"
grep -Fq 'sha256 "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"' "$formula"
grep -Fq 'https://github.com/libra-tools/libra/releases/download/v0.17.1446/libra-linux-amd64' "$formula"
grep -Fq 'sha256 "bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb"' "$formula"
grep -Fq 'https://github.com/libra-tools/libra/releases/download/v0.17.1446/libra-linux-arm64' "$formula"
